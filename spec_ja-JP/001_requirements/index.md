...
- @/home/kbaba/repos/github/simple-ffmpegjs
  - やりたいことに近い機能があるので参考にすること
- https://book.babashka.org/
  - Babashka のドキュメント
- https://github.com/babashka/babashka/tree/master/examples
  - Babashka のサンプルコード
- https://github.com/babashka/process
  - Babashka で sub-processes を呼び出すためのライブラリ。これを使って ffmpeg を動かしたい
- https://github.com/dakrone/cheshire
  - babashka で json を扱うときに使うライブラリ
  - https://github.com/babashka/json を使う必要はない
  - built-in されている cheshire.core を使う
- https://github.com/metosin/malli#babashka
  - 関数の引数、戻り値については malli で型を定義すること
  - JSONの型チェックにも malli を使うこと
- テストの作成について
  - clojure.test を babashka で動かしてテストを書くこと
  - 参考
...
```
sche scenario.jsonc -o youtube.mp4
```
